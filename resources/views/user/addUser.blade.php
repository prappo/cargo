            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus-circle"></i> Add New User</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="companyAddress"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="city" placeholder="Enter City Name">
                                </div>
                                <div class="form-group">
                                    <label><i class="fa fa-phone"></i> Phone</label>
                                    <input class="form-control" type="text" id="phone" placeholder="Enter Phone Number">
                                </div>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-6">
                            <button id="register" class="btn btn-block btn-success"><i class="fa fa-edit"></i> Register
                            </button>
                        </div>
                    </div>
                </div>
