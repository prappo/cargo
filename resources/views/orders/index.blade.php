                        ...
                        <div class="box box-info">
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="cCity" class="col-sm-4 control-label">Customer City</label>
                                    ...
                                    <div class="form-group">
                                        <label for="cPhone" class="col-sm-4 control-label">Customer Phone</label>
                                    ...
                                    <div class="form-group">
                                        <label for="cAddress" class="col-sm-4 control-label">Customer Address</label>
