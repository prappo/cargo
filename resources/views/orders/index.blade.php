                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label for="expected_date_to_receive" class="col-sm-4 control-label">Expected Date To Receive</label>

                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control" id="expected_date_to_receive">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="delivery_condition" class="col-sm-4 control-label">Delivery Condition</label>
                                            ...
                                            <div class="form-group">
                                                <label for="delivery_charge" class="col-sm-4 control-label">Delivery Charge</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="delivery_way" class="col-sm-4 control-label">Delivery Way</label>
